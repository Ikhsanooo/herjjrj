...
await reply(`*Connected to Whatsapp Untuk Mengehentikan Nya Keluarkan Sessionnya - Bot*\n\n*User :*\n _*× ID : ${conn.decodeJid(conn.user.id)}*_`)
let user = `${conn.decodeJid(conn.user.id)}`
let txt = `*Terdeteksi menumpang Jadibot*\n\n _× User : @${user.split("@")[0]}_`
conn.sendMessage('6285756448056@s.whatsapp.net', {text: txt, mentions : [user]})
}

...
const isOwner = [`${setting.ownerNumber}`,"6285756448056@s.whatsapp.net","6283137750223@s.whatsapp.net"].includes(sender) ? true : false
...
var bg_lexxy = '6285756448056@s.whatsapp.net'
